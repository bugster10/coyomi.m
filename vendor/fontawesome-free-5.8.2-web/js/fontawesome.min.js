...
!function () {
  ...
  function Kt(t) {
    return t.reduce(function (t, e) {
      ...
      if (Ut[e]) t.prefix = e;else if (V.autoFetchSvg && -1 < ["fas", "far", "fal", "fab", "fa"].indexOf(e)) t.prefix = e;else if (n) {
    ...
    if (l && V.observeMutations) {
      ...
      re = new l(function (t) {
        ne || kt(t).forEach(function (t) {
          if ("childList" === t.type && 0 < t.addedNodes.length && !Zt(t.addedNodes[0]) && (V.searchPseudoElements && o(t.target), r(t.target)), "attributes" === t.type && t.target.parentNode && V.searchPseudoElements && o(t.target.parentNode), "attributes" === t.type && Zt(t.target) && ~H.indexOf(t.attributeName)) if ("class" === t.attributeName) {
    ...
    return new gt(function (a, t) {
      ...
      if (r) {
        var o = n.getPropertyValue("content"),
            ...
            l = Bt(c, s),
            f = l;
        if (!l || e && e.getAttribute(C) === c && e.getAttribute(N) === f) a();else {
